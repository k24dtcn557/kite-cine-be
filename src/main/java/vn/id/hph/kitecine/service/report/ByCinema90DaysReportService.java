...
public class ByCinema90DaysReportService implements DashboardReportService {
    TicketService ticketService;
    CinemaService cinemaService;

    @Override
    public ReportType getTimeRange() {
        return ReportType.BY_CINEMA_90_DAYS;
    }
